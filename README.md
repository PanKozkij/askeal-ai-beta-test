🧪 Askeal AI — Beta QA Testing Project

> **Independent quality assurance project for an LLM-based chatbot assistant**
...
- ✅ Design an independent **Test Strategy** covering all key areas
- ✅ Achieve **maximum test coverage** across functional, LLM quality, and security
- ✅ Apply **LLM-specific testing techniques** (hallucination, prompt injection, RAG)
- ✅ Demonstrate understanding of **OWASP LLM Top-10 vulnerabilities**
- ✅ Produce professional **test artifacts** (plan, cases, reports, checklists)
